    ...
    <div className={styles.subheadingsDiv}>
      <Tabs colorScheme="red" >
        <TabList className={styles.tabList}>
          <Tab color="#7F7F7F" className={styles.p}>Lorem Ipsum</Tab>
          <Tab color="#7F7F7F" className={styles.p}>Dolor Sit Ament</Tab>
          <Tab color="#7F7F7F" className={styles.p}>Consectetur adipiscing elit</Tab>
        </TabList>
